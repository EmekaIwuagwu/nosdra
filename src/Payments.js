  ...
  render() {
    return (
        ...
        <Image
         ...
         style={styles.logo} />
        <Text style={{textAlign:'left',fontSize:25,color: '#b8b9b8'}}> Make Payment</Text>
        <Text style={{textAlign:'left',fontSize:10,color: '#b8b9b8'}}> Create new Payment Request.</Text>
        ...
        <Text style={styles.loginbtn}> Make Payment </Text>
         </TouchableOpacity>
      </View>
    );
  }
